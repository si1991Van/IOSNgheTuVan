...
extension DmgApi {
    ...
    func post(method : String ,params: [String: Any]?, headers: [String: String]? = nil ,completion: @escaping (Response) -> Void){
        self.request(url: "/" + apiEndpoint + "/" + method, method: .post,params: params, headers: headers, completion: completion)
    }
    
    func post(method : String ,rawStringJson: String?, headers: [String: String]? = nil ,completion: @escaping (Response) -> Void){
        self.request(url: "/" + apiEndpoint + "/" + method, method: .post, params: rawStringJson ?? "", headers: headers, completion: completion)
    }
    
    func postUrlEncoded(method : String ,params: [String: Any]?, headers: [String: String]? = nil ,completion: @escaping (Response) -> Void){
    ...
    func get(queryString: String,  headers: [String: String]? = nil ,completion: @escaping (Response) -> Void){
        self.request(url: "/" + apiEndpoint + "/" + queryString , method: .get, headers: headers, completion: completion)
    }
    
    func put(method: String,  params: [String: Any]?, headers: [String: String]? = nil ,completion: @escaping (Response) -> Void){
        self.request(url: "/" + apiEndpoint + "/" + method, method: .put,params: params, headers: headers, completion: completion)
    }
    func put(method: String,  rawStringJson: String?, headers: [String: String]? = nil ,completion: @escaping (Response) -> Void){
        self.request(url: "/" + apiEndpoint + "/" + method, method: .put, params: rawStringJson ?? "", headers: headers, completion: completion)
    }
    
    func delete(itemId: String,  headers: [String: String]? = nil ,completion: @escaping (Response) -> Void){
        self.request(url: "/" + apiEndpoint + "/" + itemId, method: .delete, headers: headers, completion: completion)
    }
    
    private func request(url: String, method:HTTPMethod, params: [String: Any]? = nil, encoding: ParameterEncoding = JSONEncoding.default, headers: [String: String]?, completion: @escaping (Response) -> Void){
        AlamofireHandler.sharedInstance.request(self.apiUrl + url.replacingOccurrences(of: "/+", with: "/", options: .regularExpression, range: nil),
                                                method:method, parameters: params, encoding: encoding, headers: headers).response {
                                                    response in
                                                    completion(Response(response.data, response.response, response.error))
        }
    }
    
    private func request(url: String, method:HTTPMethod, params: String, headers: [String: String]?, completion: @escaping (Response) -> Void){
    ...
    func upload(method: String,multipartFormData: @escaping (MultipartFormData) -> Void,headers: [String: String]? = nil, completion: @escaping (Response) -> Void) -> Void {
        ...
        AlamofireHandler.sharedInstance.upload(multipartFormData: multipartFormData,
                                               ...
                                               method:.post,  headers: headers, encodingCompletion: { encodingResult in
                                                ...
                                                case .failure(let encodingError):
                                                    completion(Response(nil, nil, encodingError))
                                                    break
                                                }
        })
    }
    ...
    //    func setHeaders(_ headers: [String: String]?) -> [String: String]? {
    //        var headers = headers
    //        if headers == nil {
    //            headers = [:]
    //        }
    ////        if let token = authorizationString {
